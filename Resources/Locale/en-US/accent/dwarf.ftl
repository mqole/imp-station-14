...
# IMP EDIT: the added dwarfcomponent.cs uses ' as an escape character, so new word replacements don't needed to be added for every contraction with and without an apostrophe.
...
accent-dwarf-words-replace-8 = ah be

# imp
accent-dwarf-words-9 = im
accent-dwarf-words-replace-9 = ah be
...
accent-dwarf-words-replace-13 = ye be

# imp
accent-dwarf-words-14 = youre
accent-dwarf-words-replace-14 = ye be
